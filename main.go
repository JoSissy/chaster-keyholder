...
func main() {
	...
	botUsername := os.Getenv("TELEGRAM_BOT_USERNAME") // ej: KeyholderAIBot
	...
	// Servidor HTTP para el iframe de Chaster
  ...
  <div class="card">
    ...
    <div class="features">
      <div class="feature">
        ...
        <span>Daily tasks with photo verification via AI vision</span>
      </div>
      <div class="feature">
        <span class="feature-icon">❄️</span>
        <span>Random control events — freeze, hide timer, pillory</span>
      </div>
      <div class="feature">
        <span class="feature-icon">⏱</span>
        <span>Automatic time rewards and penalties</span>
      </div>
      <div class="feature">
        <span class="feature-icon">💬</span>
        <span>Chat freely with your AI keyholder anytime</span>
      </div>
    </div>
